...
SELECT COUNT(*) AS "Quantidade de registros na tabela cliente" FROM CLIENTE;
...
/* Traga a quantidade os funcionarios que trabalham no departamento de filmes OU no departamento de roupas*/

/* Primeiro ver as ocorrencias de funcionarios no departamento */
SELECT COUNT(*) AS Quantidade, departamento FROM funcionarios GROUP BY departamento;

/* Todos os funcionarios que trabalham no departamento de filmes OU no departamento de roupas */
SELECT COUNT(*) AS Quantidade, departamento AS Departamento FROM funcionarios WHERE departamento = 'Filmes' OR departamento = 'Roupas' GROUP BY departamento;

/* Listar as funcionarias que trabalhem no departamento de filmes ou no departamneto lar*/

/* Primeiro ver as ocorrencias de funcionarios pelo sexo */
SELECT COUNT(*) AS Quantidade, sexo FROM funcionarios GROUP BY sexo;

/* Depois ver as ocorrencias de funcionarios pelo departamento de filmes ou lar */
SELECT COUNT(*) AS Quantidade, departamento FROM funcionarios GROUP BY departamento;

/* Todas os funcionarios do sexo feminino que trabalhem no departamento de filmes ou no departamento lar*/
SELECT nome, sexo, departamento, email FROM funcionarios WHERE sexo = 'Feminino' AND (departamento = 'Filmes' OR departamento = 'Lar');

/* Trazer os funcionarios do sexo masculino ou os funcionarios que trabalham no departamento jardim */
...
/* PROJETAR CAMPOS NOME E EMAIL */
SELECT NOME, EMAIL FROM CLIENTE;

/* ATUALIZAR CAMPO EMAIL DO NOME LILIAN*/
UPDATE CLIENTE 
...
/* PROJETAR SEXO E QUANTIDADE */
SELECT SEXO, COUNT(*) QUANTIDADE FROM CLIENTE GROUP BY SEXO;

/* PRIMEIRA FORMA NORMAL*/
/* 
1 - TODO CAMPO VETORIZADO SE TORNARÁ OUTRA TABELA ;
2 - TODO CAMPO MULTIVALORADI SE TORNARÁ OUTRA TABELA;
3 - TODA TABELA NECESSITA DE PELO MENOS UM CAMPO QUE IDENTIFIQUE 
TODO O REGISTRO COMO SENDO ÚNICO, (CHAVE PRIMÁRIA OU PRIIMARY KEY);
*/

/* CARDINALIDADE */
/* QUEM DEFINE A CARDINALIDADE É A REGARA DE NEGÓCIOS */

/* 

PRIMEIRO ALGARISMO - OBROGATORIEDADE 
0 - NÃO OBRIGATÓRIO
1 - OBRIGATÓRIO
...
/* 
CHAVE ESTRANGEIRA É CHAVE DE UMA TABELA QUE VAI ATÉ A OUTRA TABELA 
...
EM RELACIONAMENTO NXN A CHAVE ESTRANGEIRA
*/
...
INSERT INTO CLIENTE VALUES(NULL,'JOAO','M','JOAO@GMAIL.COM','12345678990');
INSERT INTO CLIENTE VALUES(NULL,'JOSE','M','JOSE@GMAIL.COM','12346578991');
INSERT INTO CLIENTE VALUES(NULL,'LUCIANO','M','LUCIANO@GMAIL.COM','76567587887');
...
+-----------+---------+------+-------------------+-------------+
|         1 | JOAO    | M    | JOAO@GMAIL.COM    | 12345678990 |
|         2 | JOSE    | M    | JOSE@GMAIL.COM    | 12345678991 |
|         3 | LUCIANO | M    | LUCIANO@GMAIL.COM | 76567587887 |
|         4 | CARLOS  | M    | CARLOSA@IG.COM    | 5464553466  |
|         5 | ANA     | F    | ANA@IG.COM        | 456545678   |
|         6 | CLARA   | F    | NULL              | 5687766856  |
|         7 | JORGE   | M    | JORGE@IG.COM      | 8756547688  |
|         8 | CELIA   | M    | JCELIA@IG.COM     | 5767876889  |
+-----------+---------+------+-------------------+-------------+
...
/* SELEÇÃO */
SELECT NOME, SEXO, EMAIL /* SELEÇÃO */
FROM CLIENTE /* ORIGEM */
...
INSERT INTO ENDERECO VALUES(NULL,'RUA GUEDES','CASCADURA','B. HORIZONTE','MG',22);
INSERT INTO ENDERECO VALUES(NULL,'RUA MAIA LACERDA','ESTACIO','RIO DE JANEIRO','RJ',23);
INSERT INTO ENDERECO VALUES(NULL,'RUA VISCONDESSA','CENTRO','RIO DE JANEIRO','RJ',24);

/* CADASTRE TELEFONES PARA OS CLIENTES */


INSERT INTO TELEFONE VALUES(NULL,'CEL','68976565',7);
INSERT INTO TELEFONE VALUES(NULL,'RES','99656675',2);
...
INSERT INTO TELEFONE VALUES(NULL,'COM','88988988',24);


DESC CLIENTE; /* DESCOBRIR OS NOMES DAS COLUNAS */
+-----------+---------------+------+-----+---------+----------------+
| Field     | Type          | Null | Key | Default | Extra          |
+-----------+---------------+------+-----+---------+----------------+
...
DESC ENDERECO; /* DESCOBRIR OS NOMES DAS COLUNAS */
...
+------------+-------------+------+-----+---------+----------------+
DESC TELEFONE; /* DESCOBRIR OS NOMES DAS COLUNAS */
...
/* UPDATE EM MUITOS DE UMA SÓ VEZ */
UPDATE CLIENTE
SET SEXO = 'F' 
...
AND TIPO != 'CEL' AND TIPO != 'COM' AND TIPO != 'RES'; /* ARRUMAR DEPOIS*/
...
| JOSE    | JOSE@GMAIL.COM    | RJ     | 54768899 |
| JOSE    | JOSE@GMAIL.COM    | RJ     | 88687909 |
| JOSE    | JOSE@GMAIL.COM    | RJ     | 99656675 |
| LUCIANO | LUCIANO@GMAIL.COM | SP     | 78989765 |
| LUCIANO | LUCIANO@GMAIL.COM | SP     | 99766676 |
| ANA     | ANA@IG.COM        | ES     | 56576876 |
| ANA     | ANA@IG.COM        | ES     | 89986668 |
| CLARA   | NULL              | RJ     | 33567765 |
| JORGE   | JORGE@IG.COM      | RJ     | 68976565 |
| JORGE   | JORGE@IG.COM      | RJ     | 88668786 |
...
| CARMEM  | CARMEM@IG.COM     | MG     | 78458743 |
| CARMEM  | CARMEM@IG.COM     | MG     | 44522578 |
| ADRIANA | ADRIANA@GMAIL.COM | RJ     | 55689654 |
| JOICE   | JOICE@GMAIL.COM   | RJ     | 88988988 |
+---------+-------------------+--------+----------+
...
'ANDREIA','F','ANDREIA@UOL.COM.BR','873547864','CENTRO','VITORIA','ES'
);/* --------------- NÃO FUNCIONA ------------*/
...
/*----------- É POSSÍVEL FAZER UPDATE EM VIEW */

/* SELECT DENTRO DE UMA VIEW */
...
/* OERDENAR PELO NOME DA COLUNA*/
SELECT * FROM ALUNOS
ORDER BY NUMERO;

/* OERDENAR PELO NÚMERO DA COLUNA*/
SELECT * FROM ALUNOS
ORDER BY 1;
...
CALL CAD_CURSO("POWER BI",35,1000.00);
CALL CAD_CURSO("TABLEAU",35,1200.00);
...
/* MIN - TRAZ VALOR MÍNIMO DE UMA COLUNA */

SELECT MIN(FEVEREIRO) AS MENOR_FEV
FROM VENDEDORES;

/* AVG - TRAZ VALOR MÉDIO DE UMA COLUNA */
...
/* VENDEDOR QUE VENDEU MAIS QUE O VALOR MEDIO EM FEVEREIRO E O SEU NOME */
...
/* CONSTRAINTS */
/* PADRÃO - CÓD (PK,FK) _TABELA PERTENCENTE _ TABELA DE ONDE VEM */
